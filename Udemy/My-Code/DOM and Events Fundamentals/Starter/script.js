...
let score = 20;
let highscore = 0;
// document.querySelector('.message').textContent = 'Start Guessing'; // * General Method
...
document.querySelector('.check').addEventListener('click', function() {
        const guess = Number(document.querySelector('.guess').value); // ! Don't forget about the (.value) as the entered value is a number. 
        ...
        // console.log(secretNumber,guess, typeof(guess), typeof(secretNumber)) ;
})
